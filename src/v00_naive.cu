...
template <typename T>
__global__ void convolution_v00(size_t m, size_t n, size_t r, T const* A,
...
template void launch_kernel_convolution_v00<float>(size_t m, size_t n, size_t r,
